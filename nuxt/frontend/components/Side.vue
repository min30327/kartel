                ...
                <nav class="l-sidebar__nav">
                    <ul class="l-sidebar__nav--list">
                        <li class="l-sidebar__nav--item">
                            <router-link  :to="'/dashboard'" class="l-sidebar__nav--link"><span>Dashboard</span></router-link>
                        </li>
                        <li class="l-sidebar__nav--item">
                            <router-link  :to="'/profile'" class="l-sidebar__nav--link"><span>Profile</span></router-link>
                        </li>
                    </ul>
                    <ul class="l-sidebar__nav--list">
                        <li class="l-sidebar__nav--item">
